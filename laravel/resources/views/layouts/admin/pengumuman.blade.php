        ...
        <div class="container-fluid">
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="/tambah-pengumuman" class="btn med btn-success float-right">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
                                            <a href="/edit-pengumuman" class="btn btn-sm btn-warning">
                                                <i class="far fa-edit"></i>
                                                Edit
                                            </a>
                                            <a href="/delete-pengumuman" class="btn btn-sm btn-danger">
