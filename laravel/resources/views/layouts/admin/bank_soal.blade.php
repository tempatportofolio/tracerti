                    ...
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body" style="margin-top:2px;">
                            <div class="dataTables_wrapper dt-bootstrap4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table style="text-align:center;" id="example1"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>f2</td>
                                                    <td style="text-align:left;">Menurut Anda seberapa besar penekanan
                                                        perkuliahan di laksanakan di program studi Anda?</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>f2</td>
                                                    <td style="text-align:left;">Menurut Anda seberapa besar penekanan
                                                        demonstrasi di laksanakan di program studi Anda?</td>
                                                    <td>Metode Pembelajaran</td>
                                                    <td>2</td>
                                                    <td style="text-align: center;vertical-align: middle;">
                                                        <a href="/detail-soal" class="btn btn-sm btn-success">
