            ...
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                    ...
                    <fieldset class="fieldset-border">
                        <legend class="legend-border">Silahkan mengubah data jenis jawaban pada form dibawah ini.
                        </legend>
                        <form action="" method="" role="form" id="quickForm">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Jenis Jawaban</label>
                                <input type="text" name="text" class="form-control" id="exampleInputEmail1" value="Text"
                                    placeholder="">
                            </div>
