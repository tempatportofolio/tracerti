                        ...
                        <form role="form" id="quickForm">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="judul"
                                    placeholder="Contoh : Penekanan Pelaksanaan Perkuliahan">
                            </div>
                            <div class="form-group">
                                <label for="soal">Soal : </label>
                                <select class="form-control" name="soal" id="soal">
                                    <option value="">(f2) Menurut Anda Seberapa besar penekanan perkuliahan dilaksanakan
                                        di program studi anda?</option>
                                    <option value="">(f2) Menurut Anda Seberapa besar penekanan perkuliahan dilaksanakan
                                        di program studi anda?</option>
                                    <option value="">(f2) Menurut Anda Seberapa besar penekanan perkuliahan dilaksanakan
                                        di program studi anda?</option>
