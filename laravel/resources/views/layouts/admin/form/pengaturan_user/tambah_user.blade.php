                    ...
                    <fieldset class="fieldset-border">
                        ...
                        <form action="" method="" role="form" id="quickForm">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_user" placeholder="Contoh : Ilham Budianto"
                                    class="form-control" id="exampleInputEmail1" placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Email</label>
                                <input type="email" name="email_user" class="form-control"
                                    placeholder="Contoh : Ilhambudianto@gmail.com" id="exampleInputEmail1"
                                    placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Username</label>
                                <input type="text" name="uname" class="form-control"
                                    placeholder="Contoh : ilhambudianto_" id="exampleInputPassword1" placeholder="">
                            </div>
                            <div class="form-group">
