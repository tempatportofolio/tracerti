...
@section('title')
Tambah Kategori Soal | Tracer Study
@endsection
                ...
                <div class="card-body">
                    ...
                    <fieldset class="fieldset-border">
                        <form action="" method="" role="form" id="quickForm">
                            <legend class="legend-border">Silahkan menambah kategori soal pada form dibawah ini.
                            </legend>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nama Kategori</label>
                                <input type="text" name="nama_kat" class="form-control" id="exampleInputEmail1"
