                            ...
                            <fieldset class="fieldset-border">
                                ...
                                <form action="" method="get">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control col-sm-2" type="text" placeholder="Contoh : f2"
                                            name="kode_soal" id="">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control col-sm-2" placeholder="Contoh : 1" type="text"
                                            name="no_urut" id="">
                                    </div>
                                    <div class="form-group">
