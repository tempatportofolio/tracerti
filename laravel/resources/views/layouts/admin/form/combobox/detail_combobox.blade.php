              ...
              <div class="modal-body" style="background:#fff; color:#000;">
                <form action="" role="form" id="quickForm">
                      <div class="form-group">
                        ...
                        <input type="text" name="nilai_combobox" class="form-control" id="exampleInputEmail1" placeholder="Contoh : 60001">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Keterangan</label>
                        <input type="text" name="ket_combobox" class="form-control" id="exampleInputPassword1" placeholder="Contoh : S3 Ilmu Ekonomi">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">No. Urut</label>
                        <input type="text" name="no_urut" class="form-control" id="exampleInputPassword1" placeholder="Contoh : 1">
                      </div>
                      <div class="form-group">
