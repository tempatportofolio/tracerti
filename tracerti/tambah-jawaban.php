...
<head>
  ...
  <title>Tambah Jenis Jawaban | Tracer Study</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="jenis-jawaban.php">Jenis Jawaban</a></li>
                    ...
                    <form action="" method="" role="form" id="quickForm">
                        <div class="card-body">
                            <div class="form-group">
                                <a class="btn bg-yellow" style="padding:5px 15px;" href="jenis-jawaban.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="text" class="form-control" id="exampleInputEmail1" placeholder="Ex : Text">
                            </div>
