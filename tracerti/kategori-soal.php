...
<head>
  ...
  <title>Kateogri Soal | Tracer Study</title>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="dataTables_wrapper dt-bootstrap4">
                                    <a href="tambah-kategori.php" class="btn btn-success float-right">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: center;vertical-align: middle;">
                                                <a href="edit-kategori.php" class="btn btn-sm btn-warning">
                                                <i class="far fa-edit"></i>
                                                    Edit
                                                </a>
                                                <a href="hapus-kategori.php" class="btn btn-sm btn-danger">
